...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::CloudpdfApi.Core.ApiResponse> SendRequestAsync(
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::CloudpdfApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,

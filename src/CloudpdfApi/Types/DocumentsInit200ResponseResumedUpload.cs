...
public record DocumentsInit200ResponseResumedUpload
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned"/> if <see cref="Kind"/> is 'presigned', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'presigned'.</exception>
    public CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned AsPresigned() =>
        IsPresigned
            ? (CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned)Value!
            : throw new global::System.Exception(
                "DocumentsInit200ResponseResumedUpload.Kind is not 'presigned'"
            );

    /// <summary>
    /// Returns the value as a <see cref="CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect"/> if <see cref="Kind"/> is 'direct', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'direct'.</exception>
    public CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect AsDirect() =>
        IsDirect
            ? (CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect)Value!
            : throw new global::System.Exception(
                "DocumentsInit200ResponseResumedUpload.Kind is not 'direct'"
            );

    public T Match<T>(
        Func<CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned, T> onPresigned,
        Func<CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect, T> onDirect,
    ...
    public void Visit(
        Action<CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned> onPresigned,
        Action<CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect> onDirect,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned"/> and returns true if successful.
    /// </summary>
    public bool TryAsPresigned(
        out CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned? value
    )
    {
        if (Kind == "presigned")
        {
            value = (CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect"/> and returns true if successful.
    /// </summary>
    public bool TryAsDirect(out CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect? value)
    {
        if (Kind == "direct")
        {
            value = (CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    internal sealed class JsonConverter : JsonConverter<DocumentsInit200ResponseResumedUpload>
    {
        ...
        )
        {
            ...
            {
                "presigned" =>
                    jsonWithoutDiscriminator.Deserialize<CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned"
                        ),
                "direct" =>
                    jsonWithoutDiscriminator.Deserialize<CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect"
                        ),
    ...
    {
        public Presigned(CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned value)
        {
            Value = value;
        }

        internal CloudpdfApi.DocumentsInit200ResponseResumedUploadPresigned Value { get; set; }
    ...
    {
        public Direct(CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect value)
        {
            Value = value;
        }

        internal CloudpdfApi.DocumentsInit200ResponseResumedUploadDirect Value { get; set; }

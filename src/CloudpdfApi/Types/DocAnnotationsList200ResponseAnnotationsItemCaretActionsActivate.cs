...
public record DocAnnotationsList200ResponseAnnotationsItemCaretActionsActivate : IJsonOnDeserialized
{
    ...
    public IEnumerable<DocAnnotationsList200ResponseAnnotationsItemCaretActionsActivateWarningsItem> Warnings { get; set; } =
        new List<DocAnnotationsList200ResponseAnnotationsItemCaretActionsActivateWarningsItem>();

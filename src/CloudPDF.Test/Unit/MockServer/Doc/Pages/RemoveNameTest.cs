...
public class RemoveNameTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/docs/docId/layers/layerName/pages/names/delete")
        ...
        var response = await Client.Doc.Pages.RemoveNameAsync(

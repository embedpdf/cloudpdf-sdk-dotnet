...
public class InsertBlankTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/docs/docId/layers/layerName/pages/insert-blank")
        ...
        var response = await Client.Doc.Pages.InsertBlankAsync(

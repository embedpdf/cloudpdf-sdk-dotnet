...
[Serializable]
public record DocPagesSetScaleRequestMeasureXItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesSetScaleRequestMeasureXItemFraction? Fraction { get; set; }
    ...
    public DocPagesSetScaleRequestMeasureXItemLabelPosition? LabelPosition { get; set; }

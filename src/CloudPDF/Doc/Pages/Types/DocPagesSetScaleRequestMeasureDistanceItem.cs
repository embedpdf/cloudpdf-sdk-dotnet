...
[Serializable]
public record DocPagesSetScaleRequestMeasureDistanceItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required double Conversion { get; set; }

    [JsonPropertyName("fraction")]
    public DocPagesSetScaleRequestMeasureDistanceItemFraction? Fraction { get; set; }
    ...
    public DocPagesSetScaleRequestMeasureDistanceItemLabelPosition? LabelPosition { get; set; }

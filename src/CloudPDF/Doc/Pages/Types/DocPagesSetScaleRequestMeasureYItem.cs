...
[Serializable]
public record DocPagesSetScaleRequestMeasureYItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesSetScaleRequestMeasureYItemFraction? Fraction { get; set; }
    ...
    public DocPagesSetScaleRequestMeasureYItemLabelPosition? LabelPosition { get; set; }

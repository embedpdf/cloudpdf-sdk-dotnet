    ...
    : IJsonOnDeserialized
{
    ...
    public IEnumerable<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsCursorEnterWarningsItem> Warnings { get; set; } =
        new List<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsCursorEnterWarningsItem>();

...
public readonly record struct DocFormsSetValue400ResponseCode : IStringEnum
{
    ...
    public static readonly DocFormsSetValue400ResponseCode SharePasswordRequired = new(
    ...
    public static readonly DocFormsSetValue400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocFormsSetValue400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocFormsSetValue400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocFormsSetValue400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocFormsSetValue400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocFormsSetValue400ResponseCode StaleBase = new(Values.StaleBase);

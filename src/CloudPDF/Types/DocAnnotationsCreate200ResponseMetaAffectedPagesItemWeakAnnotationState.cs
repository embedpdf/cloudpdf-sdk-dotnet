...
public record DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationState
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> if <see cref="Kind"/> is 'unknown', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'unknown'.</exception>
    public CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown AsUnknown() =>
        IsUnknown
            ? (CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown)
                Value!
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> if <see cref="Kind"/> is 'known', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'known'.</exception>
    public CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown AsKnown() =>
        IsKnown
            ? (CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown)
                Value!
            : throw new global::System.Exception(
    ...
    public void Visit(
        Action<CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown> onUnknown,
        Action<CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown> onKnown,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> and returns true if successful.
    /// </summary>
    public bool TryAsUnknown(
        out CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown? value
    )
    {
        if (Kind == "unknown")
        {
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> and returns true if successful.
    /// </summary>
    public bool TryAsKnown(
        out CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown? value
    )
    {
        if (Kind == "known")
        {
        ...
        : JsonConverter<DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationState>
    {
        ...
        )
        {
            ...
            {
                "unknown" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"
                        ),
                "known" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"
                        ),
    ...
    {
        public Unknown(
            CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown Value { get; set; }
    ...
    {
        public Known(
            CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocAnnotationsCreate200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown Value { get; set; }

...
public readonly record struct DocPagesInsert404ResponseCode : IStringEnum
{
    ...
    public static readonly DocPagesInsert404ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocPagesInsert404ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocPagesInsert404ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocPagesInsert404ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocPagesInsert404ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocPagesInsert404ResponseCode StaleBase = new(Values.StaleBase);

...
public readonly record struct DocAnnotationsUpdate404ResponseCode : IStringEnum
{
    ...
    public static readonly DocAnnotationsUpdate404ResponseCode SharePasswordRequired = new(
    ...
    public static readonly DocAnnotationsUpdate404ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocAnnotationsUpdate404ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocAnnotationsUpdate404ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocAnnotationsUpdate404ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocAnnotationsUpdate404ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocAnnotationsUpdate404ResponseCode StaleBase = new(Values.StaleBase);

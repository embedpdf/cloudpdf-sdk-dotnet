...
public record DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationState
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> if <see cref="Kind"/> is 'unknown', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'unknown'.</exception>
    public CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown AsUnknown() =>
        IsUnknown
            ? (CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown)
                Value!
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> if <see cref="Kind"/> is 'known', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'known'.</exception>
    public CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown AsKnown() =>
        IsKnown
    ...
    public void Visit(
        Action<CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown> onUnknown,
        Action<CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown> onKnown,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> and returns true if successful.
    /// </summary>
    public bool TryAsUnknown(
        out CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown? value
    )
    {
        if (Kind == "unknown")
        {
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> and returns true if successful.
    /// </summary>
    public bool TryAsKnown(
        out CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown? value
    )
    {
        if (Kind == "known")
        {
        ...
        : JsonConverter<DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationState>
    {
        ...
        )
        {
            ...
            {
                "unknown" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"
                        ),
                "known" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"
                        ),
    ...
    {
        public Unknown(
            CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown Value { get; set; }
    ...
    {
        public Known(
            CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocPagesFlatten200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown Value { get; set; }

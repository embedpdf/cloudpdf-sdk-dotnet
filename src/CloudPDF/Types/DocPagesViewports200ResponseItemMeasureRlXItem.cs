...
[Serializable]
public record DocPagesViewports200ResponseItemMeasureRlXItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesViewports200ResponseItemMeasureRlXItemFraction? Fraction { get; set; }
    ...
    public DocPagesViewports200ResponseItemMeasureRlXItemLabelPosition? LabelPosition { get; set; }

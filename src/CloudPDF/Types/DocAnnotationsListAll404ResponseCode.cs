...
public readonly record struct DocAnnotationsListAll404ResponseCode : IStringEnum
{
    ...
    public static readonly DocAnnotationsListAll404ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocAnnotationsListAll404ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocAnnotationsListAll404ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocAnnotationsListAll404ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocAnnotationsListAll404ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocAnnotationsListAll404ResponseCode StaleBase = new(Values.StaleBase);

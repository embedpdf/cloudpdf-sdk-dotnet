...
public record DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationState
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> if <see cref="Kind"/> is 'unknown', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'unknown'.</exception>
    public CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown AsUnknown() =>
        IsUnknown
            ? (CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown)
                Value!
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> if <see cref="Kind"/> is 'known', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'known'.</exception>
    public CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown AsKnown() =>
        IsKnown
            ? (CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown)
                Value!
            : throw new global::System.Exception(
    ...
    public void Visit(
        Action<CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown> onUnknown,
        Action<CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown> onKnown,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> and returns true if successful.
    /// </summary>
    public bool TryAsUnknown(
        out CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown? value
    )
    {
        if (Kind == "unknown")
        {
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> and returns true if successful.
    /// </summary>
    public bool TryAsKnown(
        out CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown? value
    )
    {
        if (Kind == "known")
        {
        ...
        : JsonConverter<DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationState>
    {
        ...
        )
        {
            ...
            {
                "unknown" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"
                        ),
                "known" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"
                        ),
    ...
    {
        public Unknown(
            CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown Value { get; set; }
    ...
    {
        public Known(
            CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocFormsImportData200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown Value { get; set; }

...
public readonly record struct DocPagesDelete400ResponseCode : IStringEnum
{
    ...
    public static readonly DocPagesDelete400ResponseCode SharePasswordRequired = new(
    ...
    public static readonly DocPagesDelete400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocPagesDelete400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocPagesDelete400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocPagesDelete400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocPagesDelete400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocPagesDelete400ResponseCode StaleBase = new(Values.StaleBase);

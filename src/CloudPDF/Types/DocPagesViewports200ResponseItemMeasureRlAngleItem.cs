...
[Serializable]
public record DocPagesViewports200ResponseItemMeasureRlAngleItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesViewports200ResponseItemMeasureRlAngleItemFraction? Fraction { get; set; }
    ...
    public DocPagesViewports200ResponseItemMeasureRlAngleItemLabelPosition? LabelPosition { get; set; }

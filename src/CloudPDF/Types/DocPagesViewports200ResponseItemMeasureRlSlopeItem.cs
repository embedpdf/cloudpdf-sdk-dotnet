...
[Serializable]
public record DocPagesViewports200ResponseItemMeasureRlSlopeItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesViewports200ResponseItemMeasureRlSlopeItemFraction? Fraction { get; set; }
    ...
    public DocPagesViewports200ResponseItemMeasureRlSlopeItemLabelPosition? LabelPosition { get; set; }

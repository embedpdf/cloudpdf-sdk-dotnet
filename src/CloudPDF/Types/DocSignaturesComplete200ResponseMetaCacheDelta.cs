...
[Serializable]
public record DocSignaturesComplete200ResponseMetaCacheDelta : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<DocSignaturesComplete200ResponseMetaCacheDeltaPagesItem> Pages { get; set; } =
        new List<DocSignaturesComplete200ResponseMetaCacheDeltaPagesItem>();

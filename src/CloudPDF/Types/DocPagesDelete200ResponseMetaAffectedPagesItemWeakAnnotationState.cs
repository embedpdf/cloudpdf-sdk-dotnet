...
public record DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationState
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> if <see cref="Kind"/> is 'unknown', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'unknown'.</exception>
    public CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown AsUnknown() =>
        IsUnknown
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> if <see cref="Kind"/> is 'known', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'known'.</exception>
    public CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown AsKnown() =>
        IsKnown
            ? (CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown)
                Value!
            : throw new global::System.Exception(
    ...
    public void Visit(
        Action<CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown> onUnknown,
        Action<CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown> onKnown,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> and returns true if successful.
    /// </summary>
    public bool TryAsUnknown(
        out CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown? value
    )
    {
        if (Kind == "unknown")
        {
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> and returns true if successful.
    /// </summary>
    public bool TryAsKnown(
        out CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown? value
    )
    {
        if (Kind == "known")
        {
        ...
        : JsonConverter<DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationState>
    {
        ...
        )
        {
            ...
            {
                "unknown" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"
                        ),
                "known" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"
                        ),
    ...
    {
        public Unknown(
            CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown Value { get; set; }
    ...
    {
        public Known(
            CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocPagesDelete200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown Value { get; set; }

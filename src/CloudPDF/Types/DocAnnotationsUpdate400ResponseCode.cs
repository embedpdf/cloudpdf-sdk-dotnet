...
public readonly record struct DocAnnotationsUpdate400ResponseCode : IStringEnum
{
    ...
    public static readonly DocAnnotationsUpdate400ResponseCode SharePasswordRequired = new(
    ...
    public static readonly DocAnnotationsUpdate400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocAnnotationsUpdate400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocAnnotationsUpdate400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocAnnotationsUpdate400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocAnnotationsUpdate400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocAnnotationsUpdate400ResponseCode StaleBase = new(Values.StaleBase);

...
[Serializable]
public record DocPagesViewports200ResponseItemMeasureRlDistanceItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DocPagesViewports200ResponseItemMeasureRlDistanceItemFraction? Fraction { get; set; }
    ...
    public DocPagesViewports200ResponseItemMeasureRlDistanceItemLabelPosition? LabelPosition { get; set; }

...
public readonly record struct DocPagesSetName400ResponseCode : IStringEnum
{
    ...
    public static readonly DocPagesSetName400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocPagesSetName400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocPagesSetName400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocPagesSetName400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocPagesSetName400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocPagesSetName400ResponseCode StaleBase = new(Values.StaleBase);

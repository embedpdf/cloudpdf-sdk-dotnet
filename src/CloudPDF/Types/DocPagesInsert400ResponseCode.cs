...
public readonly record struct DocPagesInsert400ResponseCode : IStringEnum
{
    ...
    public static readonly DocPagesInsert400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocPagesInsert400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocPagesInsert400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocPagesInsert400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocPagesInsert400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocPagesInsert400ResponseCode StaleBase = new(Values.StaleBase);

...
[Serializable]
public record DocVersionsAnalysis200ResponseRestrictionsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required DocVersionsAnalysis200ResponseRestrictionsItemSource Source { get; set; }

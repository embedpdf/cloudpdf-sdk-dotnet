...
public readonly record struct DocRenderResponseCode : IStringEnum
{
    ...
    public static readonly DocRenderResponseCode SigningPending = new(Values.SigningPending);

    public static readonly DocRenderResponseCode SigningExpired = new(Values.SigningExpired);

    public static readonly DocRenderResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocRenderResponseCode SignatureRefused = new(Values.SignatureRefused);

    public static readonly DocRenderResponseCode ProtectedDocument = new(Values.ProtectedDocument);

    public static readonly DocRenderResponseCode StaleBase = new(Values.StaleBase);

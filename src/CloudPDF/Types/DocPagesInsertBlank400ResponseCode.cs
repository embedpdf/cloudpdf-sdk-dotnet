...
public readonly record struct DocPagesInsertBlank400ResponseCode : IStringEnum
{
    ...
    public static readonly DocPagesInsertBlank400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocPagesInsertBlank400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocPagesInsertBlank400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocPagesInsertBlank400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocPagesInsertBlank400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocPagesInsertBlank400ResponseCode StaleBase = new(Values.StaleBase);

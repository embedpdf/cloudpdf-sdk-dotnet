...
public readonly record struct DocAnnotationsFlatten400ResponseCode : IStringEnum
{
    ...
    public static readonly DocAnnotationsFlatten400ResponseCode SigningPending = new(
        Values.SigningPending
    );

    public static readonly DocAnnotationsFlatten400ResponseCode SigningExpired = new(
        Values.SigningExpired
    );

    public static readonly DocAnnotationsFlatten400ResponseCode SigningVersionMismatch = new(
        Values.SigningVersionMismatch
    );

    public static readonly DocAnnotationsFlatten400ResponseCode SignatureRefused = new(
        Values.SignatureRefused
    );

    public static readonly DocAnnotationsFlatten400ResponseCode ProtectedDocument = new(
        Values.ProtectedDocument
    );

    public static readonly DocAnnotationsFlatten400ResponseCode StaleBase = new(Values.StaleBase);

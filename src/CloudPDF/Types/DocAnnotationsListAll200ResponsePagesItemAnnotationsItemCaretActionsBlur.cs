    ...
    : IJsonOnDeserialized
{
    ...
    public IEnumerable<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsBlurWarningsItem> Warnings { get; set; } =
        new List<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsBlurWarningsItem>();

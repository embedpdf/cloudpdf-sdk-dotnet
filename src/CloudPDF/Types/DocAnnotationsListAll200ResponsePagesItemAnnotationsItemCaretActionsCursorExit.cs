    ...
    : IJsonOnDeserialized
{
    ...
    public IEnumerable<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsCursorExitWarningsItem> Warnings { get; set; } =
        new List<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsCursorExitWarningsItem>();

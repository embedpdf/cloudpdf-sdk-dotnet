...
[Serializable]
public record DocPagesDelete200ResponseMetaCacheDelta : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<DocPagesDelete200ResponseMetaCacheDeltaPagesItem> Pages { get; set; } =
        new List<DocPagesDelete200ResponseMetaCacheDeltaPagesItem>();

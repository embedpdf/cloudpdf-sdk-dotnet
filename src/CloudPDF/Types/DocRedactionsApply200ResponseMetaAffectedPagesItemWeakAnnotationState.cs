...
public record DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationState
{
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> if <see cref="Kind"/> is 'unknown', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'unknown'.</exception>
    public CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown AsUnknown() =>
        IsUnknown
            ? (CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown)
                Value!
    ...
    /// <summary>
    /// Returns the value as a <see cref="CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> if <see cref="Kind"/> is 'known', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="Kind"/> is not 'known'.</exception>
    public CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown AsKnown() =>
        IsKnown
            ? (CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown)
                Value!
            : throw new global::System.Exception(
    ...
    public void Visit(
        Action<CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown> onUnknown,
        Action<CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown> onKnown,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"/> and returns true if successful.
    /// </summary>
    public bool TryAsUnknown(
        out CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown? value
    )
    {
        if (Kind == "unknown")
        {
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"/> and returns true if successful.
    /// </summary>
    public bool TryAsKnown(
        out CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown? value
    )
    {
        if (Kind == "known")
        {
        ...
        : JsonConverter<DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationState>
    {
        ...
        )
        {
            ...
            {
                "unknown" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown"
                        ),
                "known" =>
                    jsonWithoutDiscriminator.Deserialize<CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown?>(
                        options
                    )
                        ?? throw new JsonException(
                            "Failed to deserialize CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown"
                        ),
    ...
    {
        public Unknown(
            CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateUnknown Value { get; set; }
    ...
    {
        public Known(
            CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown value
        )
        {
            Value = value;
        }

        internal CloudPDF.DocRedactionsApply200ResponseMetaAffectedPagesItemWeakAnnotationStateKnown Value { get; set; }

    ...
    : IJsonOnDeserialized
{
    ...
    public IEnumerable<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsPageCloseWarningsItem> Warnings { get; set; } =
        new List<DocAnnotationsListAll200ResponsePagesItemAnnotationsItemCaretActionsPageCloseWarningsItem>();

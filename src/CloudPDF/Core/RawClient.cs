...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal async global::System.Threading.Tasks.Task<global::CloudPDF.Core.ApiResponse> SendRequestAsync(
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::CloudPDF.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
